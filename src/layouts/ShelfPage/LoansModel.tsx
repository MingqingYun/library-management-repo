...
export const LoansModal: React.FC<{ shelfCurrentLoan: CurrentLoansModel, returnBook:any,renewBook:any, mobile: boolean }> = (props) => {
                            ...
                            <div className='container'>
                                <div className='mt-3'>
                                    ...
                                    <div className='list-group mt-3'>
                                        ...
                                        <button onClick={()=>props.renewBook(props.shelfCurrentLoan.book.id)} data-bs-dismiss='modal' 
                                            className={
                                                props.shelfCurrentLoan.daysLeft < 0 ? 
